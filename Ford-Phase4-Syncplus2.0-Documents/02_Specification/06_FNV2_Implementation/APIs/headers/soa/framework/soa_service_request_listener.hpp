...
/*
 * soa_service_request_listener.hpp
 *
 *  Created on: Apr 10, 2017
 *      Author: PREISSNE
 */

#ifndef FNVSOA_FRAMEWORK_SOASERVICEREQUESTLISTENER_HPP_
#define FNVSOA_FRAMEWORK_SOASERVICEREQUESTLISTENER_HPP_
...
/**
 * @class SoaServiceRequestListener
 *
 * 		This class declares a callback for the handler of the remote call request message
 * 		The SOA client must implement an instance of this class to be able to
 * 		get remote call requests.
 ...
 *           to use the wrapper.
 */
class SoaServiceRequestListener : public SoaMessageListener
{
    public:
        /**
         * @brief Constructor
         ...
         * @brief Destructor
         */
        ~SoaServiceRequestListener() override;
        ...
        /**
         * @brief Signature for the remote call request handler
         *
         * The SOA client must implement this method to handle requests for service via remote call.
         *
         * @param message The message containing the remote call request
         *                This argument will never be null.
         */
        virtual void onRequestReceived(SoaMessage::SharedPtr message);
};
...
#endif /* FNVSOA_FRAMEWORK_OASERVICEREQUESTLISTENER_HPP_ */
