...
/*
 * soa_remote_call_listener.hpp
 *
 *  Created on: Mar 23, 2017
 *      Author: PREISSNE
 */

#ifndef FNVSOA_FRAMEWORK_SOAREMOTECALLLISTENER_HPP_
#define FNVSOA_FRAMEWORK_SOAREMOTECALLLISTENER_HPP_
...
/**
 * @class SoaRemoteCallListener
 *
 * 		This class declares a callback for the handler of the remote call response message
 * 		The SOA client must implement an instance of this class to be able to
 * 		get remote call responses.
 ...
 *           to use the wrapper.
 */
class SoaRemoteCallListener : public SoaMessageListener
{
    public:
    	 ...
    	 */
		explicit SoaRemoteCallListener(const std::string & name);

    	/**
    	 * Public constructor.
    	 * Creates a SoaResourceManager::Resource resource with a default name: SoaRemoteCallListener.
    	 */
         ...
         * @brief Destructor
         */
        ~SoaRemoteCallListener() override;
         ...
         *                This argument will never be null.
         */
        virtual void onResponseReceived(SoaMessage::SharedPtr message);

    private:
        SoaRemoteCallListener(const SoaRemoteCallListener &);               // explicitly disabled
        SoaRemoteCallListener & operator= (const SoaRemoteCallListener &);  // explicitly disabled
};
...
#endif /* FNVSOA_FRAMEWORK_SOAREMOTECALLLISTENER_HPP_ */
